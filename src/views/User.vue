...
import UserFavoriteRestCard from "./../components/UserFavoriteRestCard.vue";
        ...
        <div class="col-md-4">
          <div class="card">
            <div class="card-header">
              <strong>0</strong> followings (粉絲)
            </div>
            <div class="card-body"></div>
          </div>
          <br />
          <div class="card">
            <div class="card-header"><strong>2</strong> followers (追蹤中)</div>
            <div class="card-body">
              <a href="/users/2">
                <img
